...
def is_valid_animal_type(animal_type):
    """
    Checks if the given animal type is valid.
    
    Args:
    animal_type: str, the animal type to be validated
    
    Returns:
    bool, True if the animal type is valid, False otherwise
    """
